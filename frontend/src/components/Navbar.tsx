                ...
                <div className="" id="">
                    <ul className="">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" href="/kereses">Termékek</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="/toggle">undefined</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="/novcsokk">undefined</a>
                        </li>
                        ...
                        <li className="nav-item" hidden={!state}>
                            <a className="nav-link" href="/paginacio">Admin</a>
                        </li>
                    </ul>
                </div>
            </nav>
